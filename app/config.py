...
class AppSettings:
    ...
    app_version: str = os.getenv("APP_VERSION", "v2.1.3")
    build_id: str = os.getenv("BUILD_ID", "v2.1.3-replay-failure-guard")
    build_timestamp_utc: str = os.getenv("BUILD_TIMESTAMP_UTC", datetime.now(timezone.utc).isoformat())
    artifact_schema_version: str = os.getenv("ARTIFACT_SCHEMA_VERSION", "2026-05-13-v2.1.3")
